...
import com.example.chattingapp.FCM_SERVER_KEY
...
class ChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Firebase.database.reference.child(DBKey.DB_USERS).child(myUserId).get()
        ...
        binding.sendButton.setOnClickListener {
            ...
            val updates: MutableMap<String, Any> = hashMapOf(
                "${DBKey.DB_CHAT_ROOM}/$myUserId/$otherUserId/lastMessage" to message,
                "${DBKey.DB_CHAT_ROOM}/$otherUserId/$myUserId/lastMessage" to message,
                "${DBKey.DB_CHAT_ROOM}/$otherUserId/$myUserId/chatRoomId" to chatRoomId,
                "${DBKey.DB_CHAT_ROOM}/$otherUserId/$myUserId/otherUserId" to myUserId,
                "${DBKey.DB_CHAT_ROOM}/$otherUserId/$myUserId/otherUserName" to myUserName,
            )
    ...
    private fun getOtherUserData() {
        Firebase.database.reference.child(DBKey.DB_USERS).child(otherUserId).get()
            .addOnSuccessListener {
    ...
    private fun getChatData() {
        Firebase.database.reference.child(DBKey.DB_CHATS).child(chatRoomId)
